...
### 核心驱动：法规以"主体"为单位，而非以"字段"为单位

传统脱敏工具按**字段条数**统计（身份证号×1、手机号×1、银行卡号×1 = 3条），而行业监管法规的计算口径是以**个人信息主体**为单位：

| 法规 | 核心要求 | 计算单位 |
|------|---------|---------|
| **《中华人民共和国个人信息保护法》** | 第四条定义个人信息为"与已识别或可识别的自然人有关的各种信息"；第五十七条规定泄露事件需报告**涉及的个人信息主体数量**；第六十六条对违法行为的处罚力度按**个人信息主体数量**分级 | 个人信息主体（自然人） |
| **《银行保险机构消费者权益保护管理办法》（银保监会令2022年第9号）** | 第四十二条要求银行保险机构建立消费者个人信息保护机制，对个人信息实行分类分级管理，定期开展**个人信息安全影响评估** | 涉及消费者（主体） |
| **《个人信息安全规范》（GB/T 35273-2020）** | 第8.2条个人信息安全事件处置中，需按照**涉及个人信息主体数量**判断事件严重等级；附录D明确"个人敏感信息"判定标准 | 个人信息主体 |
| **《中华人民共和国数据安全法》** | 第二十一条要求建立数据分类分级保护制度；第四十五条对违法处理数据的处罚，以**涉及人数**作为量罚依据之一 | 涉及的自然人 |
| **《关于办理侵犯公民个人信息刑事案件适用法律若干问题的解释》（法释〔2017〕10号）** | 第十一条规定：向不同单位或者个人分别出售、提供**同一公民个人信息**的，信息条数**累计计算**；批量公民个人信息的条数根据查获数量直接认定。第五条规定出售或提供行踪轨迹信息 **50条以上**、健康生理等信息 **500条以上**、一般个人信息 **5000条以上**即构成**"情节严重"**，可处三年以下有期徒刑或拘役 | 每条信息（向每N个接收方分别计数） |
| **《数据出境安全评估办法》** | 第四条规定：处理**100万人以上**个人信息的数据处理者向境外提供个人信息的，或自上年1月1日起累计向境外提供**10万人以上**个人信息（或**1万人以上**敏感个人信息）的，应当通过省级网信部门向国家网信部门**申报数据出境安全评估** | 涉及的个人信息主体人数 |
| **《个人信息出境认证办法》** | 通过认证方式向境外提供个人信息的适用门槛：自当年1月1日起累计向境外提供**10万人以上、不满100万人**个人信息（不含敏感个人信息），或者**不满1万人**敏感个人信息 | 涉及的个人信息主体人数 |

> ⚠️ **刑法的放大效应**：一份保单包含 N 个个人信息主体，每人有 M 项信息条目。若向 K 家合作机构分别提供，则刑法定罪所用的"信息条数" = N × M × K。传统脱敏工具按字段去重统计（仅 M），无法暴露这个乘法放大风险。InsShield 按主体聚合后，可直观看到"哪些人的信息被提供给了多少家机构"，让合规部门能准确评估刑事风险。

**关键逻辑**：一个人同时有身份证号、手机号、家庭住址、银行卡号、职业信息，从法规角度看，这属于**1个个人信息主体的数据集合**，而非5条独立数据条目。合规报告、安全事件定级、处罚力度，都基于"涉及多少个主体"，而非"涉及多少个字段"。

InsShield 正是为此而设计——自动将同一人的所有信息聚合为一条"个人信息主体记录"，直接输出法规所需的合规口径，消除"字段统计"与"主体统计"之间的鸿沟。
